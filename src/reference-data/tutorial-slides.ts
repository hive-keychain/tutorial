...
export const getTutorialSlideDataList = (
  ...
  return [
    ...
    {
      title: "Four Keys but only three are needed.",
      description:
        "Because each Hive key has its own purpose in regards of your account security.",
      list: [
    ...
    },
    {
      ...
      list: [
        ...
        `HBD (Hive Backed Dollars): Stablecoin pegged to the US dollar, used for stable transactions. HBD can be locked in savings for a ${savingAPR}}% APR.`,
        "Hive Engine tokens are also called layer 2 tokens.",
      ],
    },
    {
